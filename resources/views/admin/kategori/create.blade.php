                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @endif
                                        <h4 class="card-title mb-4">Tambah Data Kategori</h4>
                                        <form action="{{ route('kategori.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                        <div class="row mb-4">
                                                <label for="projectname" class="col-form-label col-lg-2">Title</label>
                                                <div class="col-lg-10">
                                                    <input name="title" id="projectname" type="text" class="form-control" placeholder="Masukan Judul Title">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="projectdesc" class="col-form-label col-lg-2">Deskripsi</label>
                                                <div class="col-lg-10">
                                                    <textarea name="deskripsi" class="form-control" id="projectdesc" rows="3" placeholder="Masukan Deskripsi"></textarea>
                                                </div>
                                            </div>
                                        <div class="row mb-4">
