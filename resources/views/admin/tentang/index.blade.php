                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Tentang GAS</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @endif
                                        <h4 class="card-title mb-4">Edit Tentang Section</h4>
                                        <form action="{{ route('tentang.update', $tentang->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-lg-10">
                                                    <input name="title" id="projectname" type="text" class="form-control" placeholder="Masukan Judul Title" value="{{ $tentang->title }}">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="projectdesc" class="col-form-label col-lg-2">Deskripsi</label>
                                                <div class="col-lg-10">
                                                    <textarea name="deskripsi" class="form-control" id="projectdesc" rows="3" placeholder="Masukan Deskripsi">{{ $tentang->deskripsi }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <label   for="cover" class="col-form-label col-lg-2">Gambar Ilustrasi</label>
                                                ...
                                                <div class="col-md-5 text-center">
                                                    <img class="rounded me-2" alt="200x200" src="/images/{{$tentang->gambar}}" data-holder-rendered="true" width="200">
                                                </div>
                                        </div>
                                        <div class="row justify-content-end">
                                            <div class="col-lg-10">
                                                <button type="submit" class="btn btn-primary">Update Data Tentang</button>
                                            </div>
                                        </div>
                                        </form>
